...
const _require2 = require('@azure/ms-rest-nodeauth'),
      loginWithUsernamePassword = _require2.loginWithUsernamePassword,
      loginWithVmMSI = _require2.loginWithVmMSI,
      loginWithAppServiceMSI = _require2.loginWithAppServiceMSI,
      loginWithServicePrincipalSecret = _require2.loginWithServicePrincipalSecret;
        ...
        if (this.fedAuthInfoToken && this.fedAuthInfoToken.stsurl && this.fedAuthInfoToken.spn) {
          ...
          const getToken = callback => {
            ...
            if (authentication.type === 'azure-active-directory-password') {
              ...
              loginWithServicePrincipalSecret(authentication.options.clientId, authentication.options.clientSecret, authentication.options.tenantId, {
                tokenAudience: this.fedAuthInfoToken.spn
              }, getTokenFromCredentials);
            }
          };
